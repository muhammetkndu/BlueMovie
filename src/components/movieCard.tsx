...
export default function MovieRow({
  ...
  return (
    <div className="relative w-full text-white my-10">
      ...
      <div
        ref={scrollRef}
        className="overflow-x-scroll no-scrollbar scroll-smooth p-4 flex gap-4"
      >
        {films.map((film) => (
          <div
            onClick={() => setSelectedMovie(film)}
            key={film.id}
            className="w-60 h-80 flex-shrink-0 relative rounded-xl overflow-hidden bg-gray-800 group"
          >
            <img
